...
public class UserInterface {
    ...
    private void processGetByVehicleType() {
        ...
        String type = keyboard.nextLine();
        ArrayList<Vehicle> vehiclesByType = DAO.getVehiclesByType(type);
    ...
    private void processGetByMilageRequest() {
        ...
        keyboard.nextLine();
        ArrayList<Vehicle> vehiclesByType = DAO.getVehiclesByMilage(minMiles,maxMiles);
        for(Vehicle car: vehiclesByType){
            System.out.printf(" vin: %s  Year: %d  Make: %s  Model: %s  Type: %s  Color: %s  Milage: %d  Price: %.2f \n",car.getVin(),car.getYear(),car.getMake(),car.getModel(),car.getVehicleType(),car.getColor(),car.getOdometer(),car.getPrice());
    ...
    private void processGetByColorRequest() {
        ...
        String type = keyboard.nextLine();
        ArrayList<Vehicle> vehiclesByType = DAO.getVehiclesByColor(type);
        for(Vehicle car: vehiclesByType){
            System.out.printf(" vin: %s  Year: %d  Make: %s  Model: %s  Type: %s  Color: %s  Milage: %d  Price: %.2f \n",car.getVin(),car.getYear(),car.getMake(),car.getModel(),car.getVehicleType(),car.getColor(),car.getOdometer(),car.getPrice());
    ...
    private void processGetByYearRequest() {
        ...
        ArrayList<Vehicle> vehiclesByType = DAO.getVehiclesByYear(min,max);
        for(Vehicle car: vehiclesByType){
            System.out.printf(" vin: %s  Year: %d  Make: %s  Model: %s  Type: %s  Color: %s  Milage: %d  Price: %.2f \n",car.getVin(),car.getYear(),car.getMake(),car.getModel(),car.getVehicleType(),car.getColor(),car.getOdometer(),car.getPrice());
    ...
    private void processGetByMakeModelRequest() {
        ...
        System.out.print("Enter the model: ");
        String model = keyboard.nextLine();
        ArrayList<Vehicle> vehiclesByType = DAO.getVehiclesByMakeModel(make,model);
        for(Vehicle car: vehiclesByType){
            System.out.printf(" vin: %s  Year: %d  Make: %s  Model: %s  Type: %s  Color: %s  Milage: %d  Price: %.2f \n",car.getVin(),car.getYear(),car.getMake(),car.getModel(),car.getVehicleType(),car.getColor(),car.getOdometer(),car.getPrice());
    ...
    private void processGetByPriceRequest() {
        ...
        ArrayList<Vehicle> vehiclesByType = DAO.getAllVehiclesByPriceRange(min,max);
        for(Vehicle car: vehiclesByType){
            System.out.printf(" vin: %s  Year: %d  Make: %s  Model: %s  Type: %s  Color: %s  Milage: %d  Price: %.2f \n",car.getVin(),car.getYear(),car.getMake(),car.getModel(),car.getVehicleType(),car.getColor(),car.getOdometer(),car.getPrice());
    ...
    private void displayVehicles()throws IOException{
        ArrayList<Vehicle> cars = DAO.getAllVehiclesFromDatabase();
    ...
    private void showList()throws IOException{
        ArrayList<Vehicle> test = DAO.getAllVehiclesFromDatabase();
    ...
    private void processBuyVehicleRequest ()throws IOException{
        ...
        DAO.addSalesContractDetails(VIN,name,date,email,isFinance);
    ...
    private void  processLeaseVehicleRequest()throws IOException{
        ...
        showList();
        String VIN = keyboard.nextLine();
        DAO.addLeaseContractDetails(VIN,name,date,email);
